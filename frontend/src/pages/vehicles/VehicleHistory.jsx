...
const VehicleHistory = () => {
  ...
  const [filters, setFilters] = useState({ search: '', actionType: '', startDate: '', endDate: '' });
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-2xl font-bold">Vehicle History: {vehicle?.licensePlate}</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card>
          <CardBody>
            ...
            <p className="text-lg font-semibold">{vehicle?.currentStatus}</p>
          </CardBody>
        </Card>
      </div>
