  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card>
          <CardBody>
            <h3 className="text-sm font-medium text-gray-600 mb-3">Contact</h3>
            <div className="space-y-2 text-sm">
              {terminal.contactNumber && <p>{terminal.contactNumber}</p>}
              {terminal.contactEmail && <p>{terminal.contactEmail}</p>}
            </div>
          </CardBody>
        </Card>
