      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">ID: {driver._id}</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card>
          ...
          <CardBody className="space-y-4">
            ...
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Vehicle</p>
          ...
          <CardBody>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <p className="font-medium">{driver.emergencyContact.relationship || 'N/A'}</p>
              </div>
              <div>
                <p className="text-sm text-gray-600">Phone</p>
                <p className="font-medium">{driver.emergencyContact.phoneNumber}</p>
              </div>
            </div>
          </CardBody>
        </Card>
